...
#   # blocker_id、blocked_idの存在
#   describe 'presence of blocker_id, blocked_id' do
#     # blocker_id、blocked_idの両方があれば有効な状態であること
#     it 'is valid with a blocked_id and blocker_id' do
#       block = Block.new(blocked_id: User.first.id, blocker_id: User.second.id)
#       expect(block).to be_valid
#     end

#     # blocker_idがなければ無効な状態であること
#     it 'is invalid without a blocker_id' do
#       block = Block.new(blocked_id: User.first.id, blocker_id: nil)
#       block.valid?
#       expect(block.errors[:blocker_id]).to include('を入力してください')
#     end

#     # blocked_idがなければ無効な状態であること
#     it 'is invalid without a blocked_id' do
#       block = Block.new(blocked_id: nil, blocker_id: User.first.id)
#       block.valid?
...
#     block = Block.new(blocked_id: User.first.id, blocker_id: User.first.id)
#     block.valid?
