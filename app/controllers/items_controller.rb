class ItemsController < ApplicationController
   ...
   private
   def item_params
     params.require(:item).permit(:id, :user_id, :super_item, :season, :tpo, :storage, :rating, :color, :memo, :picture, :content)
   end
