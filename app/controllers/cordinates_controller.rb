class CordinatesController < ApplicationController
  ...
  def cordinate_paginate
   ...
   def cordinate_params
       params.require(:cordinate).permit( :user_id, :item_id, :season, :tpo, :rating, :memo, :picture,:favorite, :si_outer, :si_shoes, :si_bottoms,:si_tops, items_attributes:[:id ])
   end
  
  def cordinate_update_params
       params.permit(:user_id, :item_id, :season, :tpo, :rating, :memo, :picture,:favorite, :si_outer, :si_shoes, :si_bottoms,:si_tops, items_attributes:[:id ])
  end
  ...
  def cordinate_si_params_set
    ...
    else  params[:cordinate_si_shoes]
